...
from evaluation.interviewer.interview_session import InterviewSession
from evaluation.persistence.candidate_state_store import CandidateStateStore
from evaluation.scoring import evaluation_orchestrator
from evaluation.scoring.candidate_state import CandidateNLPState
...
def deterministic_model_boundaries(monkeypatch):
    ...
    from evaluation.interviewer import interview_session
